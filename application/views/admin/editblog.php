<div class="page-wrapper">
          ...
          <div class="form-group">
            ...
            <textarea name="description" id="ckeditor" cols="30" rows="5" class="form-control" placeholder="Enter Blog Description"><?php echo set_value('description',$key->description); ?></textarea>
