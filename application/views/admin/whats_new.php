<div class="page-wrapper">
			<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Post What's New</h4>
            ...
            <?php endif;?>
       			<div class="card ">
       				...
       				<div class="card-body">
       					<form action="<?php echo base_url('admin/addWhatsNew');?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<input type="submit"  class="btn btn-success" value="Add What's New">
					</div>
				</form>
       				</div>
       			</div>
